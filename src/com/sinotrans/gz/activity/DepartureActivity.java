...
public class DepartureActivity extends Activity {
	private ImageButton departure_return;
	private ImageButton departure_scan;
	private ImageButton departure_submit;
	private ImageButton departure_takephoto;
	private EditText departuredonum;
...
//	private EditText departuredescribe;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gz_activity_departure);
		...
		welcome=(TextView)findViewById(R.id.departurewelcode);
		welcome.setText("欢迎"+ myApp.getUsername()+"使用手机应用系统"+version + "  " + myApp.getPosition());
		departuredonum=(EditText) this.findViewById(R.id.departuredonu);
		departuredonum.setTextColor(Color.BLUE);
		orderdetail = (ListView) findViewById(R.id.departuredodetail); 
		mImageView=(ImageView) findViewById(R.id.departure_photo); 
//		departuredescribe=(EditText) findViewById(R.id.departureexcdes); 
...
//			exception_reasion = (Spinner) findViewById(R.id.departureexception);
...
//			exceptionreasion_list= AnimationUtils.loadAnimation(this,R.anim.my_anim );	
				...
				departuredonum.setOnKeyListener(new OnKeyListener() {  
				  ...
				  if (KeyEvent.KEYCODE_ENTER == keyCode && event.getAction() == KeyEvent.ACTION_DOWN) 
				  		{  
						  			...
						  			if(!adapter.arr.contains(departuredonum.getText().toString()))
									{
										if( !"".equals(departuredonum.getText().toString())){
											hs_orderCode.put(departuredonum.getText().toString(), "");
											adapter.arr.add(departuredonum.getText().toString());
											adapter.notifyDataSetChanged();
											departuredonum.getText().clear();
											Log.i("Sinotrans","按下enter0");
//											隐藏软键盘
											Timer timer = new Timer();   
											        timer.schedule(new TimerTask(){   
											            ...
											            public void run() {   
											                ...
											                departuredonum.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);   
											...
											Toast.makeText(DepartureActivity.this, "您输入的订单号为空",
										...
										
									{
										...
										Toast.makeText(DepartureActivity.this, "您输入的订单号已录入",
													Toast.LENGTH_SHORT).show();
							  		} 
						  			
									Log.i("Sinotrans","按下enter1");
				...
				Log.i("Sinotrans","按下enter2");
				
		departure_scan = (ImageButton) this.findViewById(R.id.departurescan);
		departure_scan.setOnClickListener(new OnClickListener() {	
				@Override
				public void onClick(View v) {
					//打开扫描界面扫描条形码或二维码
					 openscanIntent = new Intent(DepartureActivity.this,ScanActivity.class);
					startActivityForResult(openscanIntent, REQUEST_SCAN_CODE);
				}
			});
		departure_return = (ImageButton) this.findViewById(R.id.departurereturn);
		departure_return.setOnClickListener(new OnClickListener() {	
 			@Override
 			public void onClick(View v){
 				finish();
// 		Intent openIntent = new Intent(DepartureActivity.this,HomeActivity.class);
// 		startActivityForResult(openIntent, 0);
 			}
 		});
		
//		暂时禁用拍照功能
//		departure_takephoto = (ImageButton) this.findViewById(R.id.departurephoto);
//		departure_takephoto.setOnClickListener(new OnClickListener() {	
//				@Override
//				public void onClick(View v) {
//					
//					//打开拍照界面
...
//		暂时禁用拍照功能		
		...
		departure_submit = (ImageButton) this.findViewById(R.id.departuresave);
		departure_submit.setOnClickListener(new OnClickListener() {	
 			@Override
 			public void onClick(View v) {
 				//打开扫描界面扫描条形码或二维码
 				String s="";
 					...
 					{
 						Toast.makeText(DepartureActivity.this, "数据保存中......",
									Toast.LENGTH_SHORT).show();
 						...
 						for(int i=0;i<orderqty;i++)
							{
 							...
 							if("success".equals(s))
 			 				{
 			 					Toast.makeText(DepartureActivity.this, "数据保存成功",
 										Toast.LENGTH_SHORT).show();
// 			 					1.8秒后跳出下个Activity
 			 					Timer timer = new Timer();   
						        timer.schedule(new TimerTask(){   
						            ...
						            public void run() {   
						            	finish();
		 				 				startActivity(new Intent(DepartureActivity.this,DepartureActivity.class));
						            }   
 			 				...
 			 				{
 			 					Toast.makeText(DepartureActivity.this, "信息保存失败"+s,
 										Toast.LENGTH_SHORT).show();
 			 					Log.i("M",s);
 			 				}	
 					}
 					else{
 						Toast.makeText(DepartureActivity.this, "订单信息为空,请录入相关订单信息",
									Toast.LENGTH_SHORT).show();
 					}
			...
			String scanResult="";
				...
				scanResult = bundle.getString("result");	
					if(!adapter.arr.contains(scanResult))
					{
							...
							Toast.makeText(DepartureActivity.this, "订单扫描成功，订单号为:"+scanResult,
									Toast.LENGTH_SHORT).show();

					}
					else 
					{
						Toast.makeText(DepartureActivity.this, "您输入的订单号已经扫描",
										Toast.LENGTH_SHORT).show();
					}
