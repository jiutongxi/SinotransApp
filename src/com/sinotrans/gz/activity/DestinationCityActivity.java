...
public class DestinationCityActivity extends Activity {
	private ImageButton destinationcity_return;
	private ImageButton destinationcity_scan;
	private ImageButton destinationcity_submit;
	private ImageButton destinationcity_takephoto;
	private EditText destinationcitydonum;
	...
	String process="ARRIVE_DISTRIBUT_STATION";
...
//	private EditText destinationcitydescribe;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gz_activity_destinationcity);
		...
		welcome=(TextView)findViewById(R.id.destinationcitywelcode);
		welcome.setText("欢迎"+ myApp.getUsername()+"使用手机应用系统"+version + "  " + myApp.getPosition());
		destinationcitydonum=(EditText) this.findViewById(R.id.destinationcitydonu);
		destinationcitydonum.setTextColor(Color.BLUE);
		orderdetail = (ListView) findViewById(R.id.destinationcitydodetail); 
		mImageView=(ImageView) findViewById(R.id.destinationcity_photo); 
//		destinationcitydescribe=(EditText) findViewById(R.id.destinationcityexcdes); 
...
//			exception_reasion = (Spinner) findViewById(R.id.destinationcityexception);
...
//			exceptionreasion_list= AnimationUtils.loadAnimation(this,R.anim.my_anim );	
				...
				destinationcitydonum.setOnKeyListener(new OnKeyListener() {  
				  ...
				  if (KeyEvent.KEYCODE_ENTER == keyCode && event.getAction() == KeyEvent.ACTION_DOWN) 
				  		{  
						  			...
						  			if(!adapter.arr.contains(destinationcitydonum.getText().toString()))
									{
										
						  				hs_orderCode.put(destinationcitydonum.getText().toString(), "");
										adapter.arr.add(destinationcitydonum.getText().toString());
										adapter.notifyDataSetChanged();
										destinationcitydonum.getText().clear();
//										隐藏软键盘
										Timer timer = new Timer();   
										        timer.schedule(new TimerTask(){   
										            ...
										            public void run() {   
										                ...
										                destinationcitydonum.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);   
										...
										
									{
										...
										Toast.makeText(DestinationCityActivity.this, "您输入的订单号已录入",
		...
		destinationcity_scan = (ImageButton) this.findViewById(R.id.destinationcityscan);
		destinationcity_scan.setOnClickListener(new OnClickListener() {	
				@Override
				public void onClick(View v) {
					//打开扫描界面扫描条形码或二维码
					 openscanIntent = new Intent(DestinationCityActivity.this,ScanActivity.class);
					startActivityForResult(openscanIntent, REQUEST_SCAN_CODE);
				}
			});
		destinationcity_return = (ImageButton) this.findViewById(R.id.destinationcityreturn);
		destinationcity_return.setOnClickListener(new OnClickListener() {	
 			@Override
 			public void onClick(View v){
 				finish();
// 		Intent openIntent = new Intent(DestinationCityActivity.this,HomeActivity.class);
// 		startActivityForResult(openIntent, 0);
 			}
 		});
//		暂时禁用拍照功能
//		destinationcity_takephoto = (ImageButton) this.findViewById(R.id.destinationcityphoto);
//		destinationcity_takephoto.setOnClickListener(new OnClickListener() {	
//				@Override
//				public void onClick(View v) {
//					
//					//打开拍照界面
...
//			});
//		暂时禁用拍照功能
		destinationcity_submit = (ImageButton) this.findViewById(R.id.destinationcitysave);
		destinationcity_submit.setOnClickListener(new OnClickListener() {	
 			@Override
 			public void onClick(View v) {
 				//打开扫描界面扫描条形码或二维码
 				String s="";
 					...
 					{
 						Toast.makeText(DestinationCityActivity.this, "数据保存中......",
									Toast.LENGTH_SHORT).show();
 						...
 						for(int i=0;i<orderqty;i++)
							{
 							...
 							if("success".equals(s))
 			 				{
 			 					Toast.makeText(DestinationCityActivity.this, "数据保存成功",
 										Toast.LENGTH_SHORT).show();
// 			 					1.8秒后跳出下个Activity
 			 					Timer timer = new Timer();   
						        timer.schedule(new TimerTask(){   
						            ...
						            public void run() {   
						            	finish();
		 				 				startActivity(new Intent(DestinationCityActivity.this,DestinationCityActivity.class));
						            }   
 			 				...
 			 				{
 			 					Toast.makeText(DestinationCityActivity.this, "信息保存失败"+s,
 										Toast.LENGTH_SHORT).show();
 			 					Log.i("M",s);
 			 				}	
 					}
 					else{
 						Toast.makeText(DestinationCityActivity.this, "订单信息为空,请录入相关订单信息",
									Toast.LENGTH_SHORT).show();
 					}
			...
			String scanResult="";
				...
				scanResult = bundle.getString("result");	
					if(!adapter.arr.contains(scanResult))
					{
							...
							Toast.makeText(DestinationCityActivity.this, "订单扫描成功，订单号为:"+scanResult,
									Toast.LENGTH_SHORT).show();

					}
					else 
					{
						Toast.makeText(DestinationCityActivity.this, "您输入的订单号已经扫描",
										Toast.LENGTH_SHORT).show();
					}
